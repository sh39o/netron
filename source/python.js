...
python.Execution = class {
    ...
    constructor(sources) {
        ...
        this.registerFunction('fastai.data.load._wif', function() {
        ...
        this.registerFunction('fastai.metrics._rmse', function() {
        ...
        this.registerFunction('fastai.optimizer.Adam', function() {
